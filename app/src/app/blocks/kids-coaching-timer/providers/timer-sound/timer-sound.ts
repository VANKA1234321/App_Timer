...
import { KCTSmartAudioProvider } from 'providers/smart-audio/smart-audio';

import * as models from 'models';
import * as constants from 'app/constant';
import { KCTEventsBroadcasterProvider } from 'providers/events-broadcaster/events-broadcaster';

@Injectable()
export class TimerSoundProvider {
    constructor(
        private events: KCTEventsBroadcasterProvider,
        private smartAudio: KCTSmartAudioProvider,
    ) {
